...
public class BookingSystem {
  ...
  public void cancelSelected() {
	...
	// 点击显示详细信息
	public void showBooking(int tno, LocalTime time, String username) {
		...
		if(name[0].equals("A") || name[0].equals("T") || name[0].equals("M")) {
			if(selectedBooking == null) {
				...
				int res = JOptionPane.showConfirmDialog(null, "This is the info of the booking:"+"\n" + 
						...
						"Class number: " + selectedBooking.getDetails() + "\n" +
						"Room number: " + selectedBooking.getRoomNumber() + "\n" + 
						"Time: " + selectedBooking.getTime()  + "\n\n" + 
						"Are you sure to change it???", "", JOptionPane.YES_NO_OPTION);
				if(res==JOptionPane.YES_OPTION) {
//					cancelSelected();
					int ans = JOptionPane.showConfirmDialog(null, "This is the info of the booking:"+"\n" + 
							"Week: " + selectedBooking.getTableNumber() + "\n" + 
							"Class number: " + selectedBooking.getDetails() + "\n" +
							"Room number: " + selectedBooking.getRoomNumber() + "\n" + 
							"Time: " + selectedBooking.getTime()  + "\n\n" + 
							"Press Y to change || Press N to delete", "", JOptionPane.YES_NO_OPTION);
					if(ans==JOptionPane.YES_OPTION) {
						JDialog addDialog = new JDialog();
						addDialog.setBounds(320, 180, 260, 200);
						addDialog.setTitle("Change info of the Booking");
						addDialog.getContentPane().setLayout(new GridLayout(6,2));
						
						addDialog.add(new JLabel("Class"));
						JTextField Class_num = new JTextField(80);
						Class_num.setText(String.valueOf(selectedBooking.getClassNum()));
						addDialog.add(Class_num);
						
						addDialog.add(new JLabel("Activity"));
						JTextField Covers = new JTextField(80);
						Covers.setText(selectedBooking.getCovers());
						addDialog.add(Covers);
						...
						addDialog.add(new JLabel("Room Num"));
						JTextField Room = new JTextField(80);
						Room.setText(selectedBooking.getRoomNumber());
						addDialog.add(Room);
			...
			JOptionPane.showMessageDialog(null, "This is the info of the booking:"+"\n" + 
					"Week: " + selectedBooking.getTableNumber() + "\n" + 
					"Class number: " + selectedBooking.getDetails() + "\n" +
					"Room number: " + selectedBooking.getRoomNumber() + "\n" + 
					"Time: " + selectedBooking.getTime());
